...
function TransactionHistory() {
    ...
    useEffect(() => {
        const fetchTransactions = async () => {
            try {
                const response = await axios.get(`http://localhost:300/api/transactions?address=${userAddress}`, {
    ...
    return (
        <div className="mt-6">
            <h3 className="text-x1 font-semibold text-gray-800 mb-2">Transaction History</h3>
